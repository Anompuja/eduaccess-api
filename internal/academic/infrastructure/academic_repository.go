...
func (r *GormAcademicRepository) CreateSubject(ctx context.Context, s *domain.Subject) error {
	m := subjectModel{ID: s.ID, SchoolID: s.SchoolID, Name: s.Name, Category: s.Category, CreatedAt: s.CreatedAt, UpdatedAt: s.UpdatedAt}
	return r.db.WithContext(ctx).Create(&m).Error
}
...
func (r *GormAcademicRepository) FindSubjectByID(ctx context.Context, id uuid.UUID) (*domain.Subject, error) {
	...
	return &domain.Subject{ID: m.ID, SchoolID: m.SchoolID, Name: m.Name, Category: m.Category, DeletedAt: m.DeletedAt, CreatedAt: m.CreatedAt, UpdatedAt: m.UpdatedAt}, nil
}
...
func (r *GormAcademicRepository) ListSubjects(ctx context.Context, schoolID *uuid.UUID) ([]*domain.Subject, error) {
	...
	for _, m := range rows {
		list = append(list, &domain.Subject{ID: m.ID, SchoolID: m.SchoolID, Name: m.Name, Category: m.Category, DeletedAt: m.DeletedAt, CreatedAt: m.CreatedAt, UpdatedAt: m.UpdatedAt})
	}
	return list, nil
}
...
func (r *GormAcademicRepository) UpdateSubject(ctx context.Context, s *domain.Subject) error {
	return r.db.WithContext(ctx).Table("school_subjects").Where("id = ?", s.ID).
		Updates(map[string]interface{}{"name": s.Name, "category": s.Category, "updated_at": s.UpdatedAt}).Error
}
...
func (r *GormAcademicRepository) CreateClassroom(ctx context.Context, c *domain.Classroom) error {
	m := classroomModel{ID: c.ID, SchoolID: c.SchoolID, Name: c.Name, Capacity: c.Capacity, Floor: c.Floor, Building: c.Building, RoomType: c.RoomType, Status: c.Status, Facilities: c.Facilities, CreatedAt: c.CreatedAt, UpdatedAt: c.UpdatedAt}
	return r.db.WithContext(ctx).Create(&m).Error
}
...
func (r *GormAcademicRepository) FindClassroomByID(ctx context.Context, id uuid.UUID) (*domain.Classroom, error) {
	...
	return &domain.Classroom{ID: m.ID, SchoolID: m.SchoolID, Name: m.Name, Capacity: m.Capacity, Floor: m.Floor, Building: m.Building, RoomType: m.RoomType, Status: m.Status, Facilities: m.Facilities, DeletedAt: m.DeletedAt, CreatedAt: m.CreatedAt, UpdatedAt: m.UpdatedAt}, nil
}
...
func (r *GormAcademicRepository) ListClassrooms(ctx context.Context, schoolID *uuid.UUID) ([]*domain.Classroom, error) {
	...
	for _, m := range rows {
		list = append(list, &domain.Classroom{ID: m.ID, SchoolID: m.SchoolID, Name: m.Name, Capacity: m.Capacity, Floor: m.Floor, Building: m.Building, RoomType: m.RoomType, Status: m.Status, Facilities: m.Facilities, DeletedAt: m.DeletedAt, CreatedAt: m.CreatedAt, UpdatedAt: m.UpdatedAt})
	}
	return list, nil
}
...
func (r *GormAcademicRepository) UpdateClassroom(ctx context.Context, c *domain.Classroom) error {
	return r.db.WithContext(ctx).Table("school_classrooms").Where("id = ?", c.ID).
		Updates(map[string]interface{}{"name": c.Name, "capacity": c.Capacity, "floor": c.Floor, "building": c.Building, "room_type": c.RoomType, "status": c.Status, "facilities": c.Facilities, "updated_at": c.UpdatedAt}).Error
}
...
type scheduleModel struct {
	ID        uuid.UUID  `gorm:"column:id;primaryKey"`
	SchoolID  uuid.UUID  `gorm:"column:school_id"`
	ShiftType string     `gorm:"column:shift_type"`
...
func (r *GormAcademicRepository) CreateSchedule(ctx context.Context, s *domain.Schedule) error {
	m := scheduleModel{ID: s.ID, SchoolID: s.SchoolID, ShiftType: s.ShiftType, StartTime: s.StartTime, EndTime: s.EndTime, CreatedAt: s.CreatedAt, UpdatedAt: s.UpdatedAt}
	return r.db.WithContext(ctx).Create(&m).Error
}
...
func (r *GormAcademicRepository) FindScheduleByID(ctx context.Context, id uuid.UUID) (*domain.Schedule, error) {
	...
	return &domain.Schedule{ID: m.ID, SchoolID: m.SchoolID, ShiftType: m.ShiftType, StartTime: m.StartTime, EndTime: m.EndTime, DeletedAt: m.DeletedAt, CreatedAt: m.CreatedAt, UpdatedAt: m.UpdatedAt}, nil
}

func (r *GormAcademicRepository) ListSchedules(ctx context.Context, schoolID *uuid.UUID) ([]*domain.Schedule, error) {
	q := r.db.WithContext(ctx).Where("deleted_at IS NULL")
	if schoolID != nil {
		q = q.Where("school_id = ?", *schoolID)
	}
	var rows []scheduleModel
	if err := q.Order("shift_type ASC").Find(&rows).Error; err != nil {
		return nil, err
	}
	list := make([]*domain.Schedule, 0, len(rows))
	for _, m := range rows {
		list = append(list, &domain.Schedule{ID: m.ID, SchoolID: m.SchoolID, ShiftType: m.ShiftType, StartTime: m.StartTime, EndTime: m.EndTime, DeletedAt: m.DeletedAt, CreatedAt: m.CreatedAt, UpdatedAt: m.UpdatedAt})
	}
	return list, nil
}
...
func (r *GormAcademicRepository) UpdateSchedule(ctx context.Context, s *domain.Schedule) error {
	return r.db.WithContext(ctx).Table("school_schedules").Where("id = ?", s.ID).
		Updates(map[string]interface{}{"shift_type": s.ShiftType, "start_time": s.StartTime, "end_time": s.EndTime, "updated_at": s.UpdatedAt}).Error
}
